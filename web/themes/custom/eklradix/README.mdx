...
eklradix theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of eklradix theme and run the following commands:
`nvm use`
...
`drush en eklradix -y`
`drush config-set system.theme default eklradix -y`
